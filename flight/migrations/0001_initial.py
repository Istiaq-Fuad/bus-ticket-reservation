# Generated by Django 3.1.2 on 2024-10-31 17:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bus_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='flight.bus')),
            ],
            options={
                'unique_together': {('bus_id', 'seat_code')},
            },
        ),
    ]
